...
- **多维筛选** — 课程类型 / 学分 / 开课单位 / 标签 / 上课区域，包含与排除双模式；正选/补退选还可「仅看有余量」
...
- **课程评价** — 匿名五维评分（总体 / 考核给分 / 考勤频率 / 课程难度 / 教学质量）+ 评语 + 「有用」投票，挑课不靠运气
- **实时人数** — 正选/补退选显示各教学班当前选课人数与余量
...
```bash
ssh -L 8790:127.0.0.1:8790 <user>@<your-vps-ip>
```
