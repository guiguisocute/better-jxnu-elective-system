...
-- 本地:  npx wrangler d1 execute jxnu-ratings --local  --file=d1_reviews_moderation_migrate.sql
-- 远端:  npx wrangler d1 execute jxnu-ratings --remote --file=d1_reviews_moderation_migrate.sql
